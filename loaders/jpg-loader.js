...
var getColor = function getColor(path) {
  return new Promise(function (resolve, reject) {
    im(path).setFormat('ppm').resize(1, 1).toBuffer(function (err, buffer) {
      if (err) return reject(err);
      var color = 'rgb(' + buffer.readUInt8(buffer.length - 3) + ',' + buffer.readUInt8(buffer.length - 2) + ',' + buffer.readUInt8(buffer.length - 1) + ')';
      resolve(color);
    });
  });
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=jpg-loader.js.map